...
Task("__Pack")
    .Does(() => {
        ...
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.OpenIDConnect" + bin462 + "/Microsoft.IdentityModel.Logging.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.OpenIDConnect" + bin462 + "/Microsoft.IdentityModel.Tokens.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.OpenIDConnect" + bin462 + "/System.IdentityModel.Tokens.Jwt.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.OpenIDConnect" + bin462 + "Octopus.Node.Extensibility.Authentication.OpenIDConnect.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.OpenIDConnect" + bin462 + "Octopus.Server.Extensibility.Authentication.OpenIDConnect.dll", odNugetPackDir);
            
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.AzureAD" + bin462 + "Octopus.Server.Extensibility.Authentication.AzureAD.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.GoogleApps" + bin462 + "Octopus.Server.Extensibility.Authentication.GoogleApps.dll", odNugetPackDir);
        CopyFileToDirectory(solutionDir + "Server.Extensibility.Authentication.Okta" + bin462 + "Octopus.Server.Extensibility.Authentication.Okta.dll", odNugetPackDir);
