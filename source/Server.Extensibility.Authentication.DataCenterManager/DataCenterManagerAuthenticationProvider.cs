...
{
    public class DataCenterManagerAuthenticationProvider : OpenIDConnectAuthenticationProvider<IDataCenterManagerConfigurationStore>
    {
        public const string ProviderName = "Data Center Manager";
        
        public DataCenterManagerAuthenticationProvider(ILog log, IDataCenterManagerConfigurationStore configurationStore) : base(log, configurationStore)
        {
        }

        public override string IdentityProviderName => ProviderName;
        public override string FilenamePrefix => "dcm";
